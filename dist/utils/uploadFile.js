...
const uploadImagePath = path.resolve(__dirname, '../..', 'public/uploads');
...
const uploadImage = (0, multer_1.default)({
    ...
    fileFilter(req, image, callback) {
        const extension = ['.png', '.jpg', '.jpeg', '.mp4', '.mov', '.avi'].indexOf(path.extname(image.originalname).toLowerCase()) >= 0;
        const mimeType = ['image/png', 'image/jpg', 'image/jpeg', 'video/quicktime', 'video/x-msvideo', 'video/mp4'].indexOf(image.mimetype) >= 0;
